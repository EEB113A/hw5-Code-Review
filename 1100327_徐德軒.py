...
def combine(l1, l2):
    ...
    temp1_head=l1.head
    temp2_head=l2.head
    temp1_last=l1.head.pre
    temp2_last=l2.head.pre
    l1.head.pre.next=temp2_head
    l1.head.pre.next.pre=temp1_last
    l1.head.pre=temp2_last
    l1.head.pre.next=temp1_head
